      ...
      <div className="home-edu">
        ...
        <div className="home-edu-school">
          <div className="home-edu-helia">
            <h4>
              Haaga-Helia Ammattikorkeakokulu{" "}
              <span>
                <h6>Business Information Technology | Software Engineering</h6>
              </span>{" "}
            </h4>
            <p>
              Identify, design, and create software apps based on client needs with suitable methods and tools. Understanding the
              importance of testing and quality insurance in a successful project. <br />
              <br />
              <span>
                <h5 className="home-edu-haaga-hashtag">#fontenddev #fullstack #backend</h5>
              </span>
            </p>
          </div>
          ...
          <div className="home-edu-xamk">
            <h4>
              South-Eastern Finland UAS |{" "}
              <span>
                <h6>International Business | Trade & Marketing</h6>
              </span>
            </h4>
            <p>
              BBA | Ecommerce | Digital business | International Entrepreneurship | International Business | Marketing
              <br />
              <br />
              <span>
                <h5 className="home-edu-haaga-hashtag">#marketing #ecom #trade #teamwork</h5>
              </span>
            </p>
          </div>
        </div>
